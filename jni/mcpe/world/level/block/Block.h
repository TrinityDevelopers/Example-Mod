...
public:
	...
	static bool mPushesOutItems[256];
	...
	virtual bool addAABBs(BlockSource&, const BlockPos&, const AABB*, std::vector<AABB>&) const;
	virtual const AABB& getAABB(BlockSource&, const BlockPos&, AABB&, int, bool, int) const;
	virtual bool addCollisionShapes(BlockSource&, const BlockPos&, const AABB*, std::vector<AABB>&, Entity*) const;
	...
	virtual void tryToPlace(BlockSource&, const BlockPos&, unsigned char) const;
	...
	virtual void spawnResources(BlockSource&, const BlockPos&, int, float, int) const;
